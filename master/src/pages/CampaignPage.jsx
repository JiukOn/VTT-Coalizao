...
import { BookOpen, Download, Upload, Plus, ChevronDown, ChevronRight, Crown, Minus, MapPin, Search, HardDrive } from 'lucide-react'
...
function DomainPanel({ characters }) {
  ...
  function handleUseAction(action) {
      ...
      <div className="page-header">
        ...
        <div style={{ display: 'flex', gap: '8px' }}>
          <button
            ...
            title="Gerenciar Snapshots e Backups automáticos em disco"
            style={{ display: 'flex', alignItems: 'center', gap: 6 }}
          >
            <HardDrive size={16} /> Snapshots (.vttpack)
          </button>
